...
/**
* BankModule/_ManagerBankStub.java .
* Generated by the IDL-to-Java compiler (portable), version "3.2"
* from Bank.idl
* Tuesday, October 24, 2017 12:13:01 o'clock AM EDT
*/

public class _ManagerBankStub extends org.omg.CORBA.portable.ObjectImpl implements BankModule.ManagerBank
{
  ...
  public String deposit (String managerID, String customerID, double amt)
  {
            ...
            try {
                ...
                return deposit (managerID, customerID, amt        );
            } finally {
                _releaseReply ($in);
            }
  } // deposit
  ...
  public String withdraw (String managerID, String customerID, double amt)
  {
            ...
            try {
                ...
                return withdraw (managerID, customerID, amt        );
            } finally {
                _releaseReply ($in);
            }
  } // withdraw
  ...
  public String getBalance (String managerID, String customerID)
  {
            ...
            try {
                ...
                return getBalance (managerID, customerID        );
            } finally {
                _releaseReply ($in);
            }
  } // getBalance
  ...
  public String transferFund (String managerID, String sourceCustomerID, double amount, String destinationCustomerID)
  {
            ...
            try {
                ...
                return transferFund (managerID, sourceCustomerID, amount, destinationCustomerID        );
            } finally {
                _releaseReply ($in);
            }
  } // transferFund
