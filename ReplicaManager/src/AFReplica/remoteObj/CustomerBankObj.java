...
import AFReplica.server.Branches;
...
public class CustomerBankObj implements CustomerBank {
	...
	public CustomerBankObj(HashMap<Character, ArrayList<Account>> records, String branch, int portNum) {
		super();
		this.records = records;
		this.branch = branch;
		this.UDPPortBase = (portNum/10)*10 + 1;
	}
